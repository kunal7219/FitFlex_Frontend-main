...
const SubscriptionPlan = () => {
    return (
        ...
        // <div classNameName='width-full border-[2px]
        // bg-[#25260a] px-[30px] py-[30px]
        // flex flex-col p-[40px] gap-[30px] rounded-[30px] 
        // hover:scale-105 tarnsition duration-150
        // '>
        //     <div classNameName='text-[2rem] flex justify-around '>Plan Name</div>

        //     <div classNameName='text-[2rem] flex justify-around'>
        //         <div>Days in a Month:</div>
        //         <div>22</div>
        //     </div>

        //     <div classNameName='text-[1.5rem] flex-col justify-around'>
        //         <div classNameName='flex justify-around'>
        //             Fitness equipment access, group fitness classNamees, personal training, locker rooms & showers,
        //             nutritional counseling
        //         </div>
        //         <div classNameName='flex justify-around line-through'>
        //             massage therapy, childcare, pool & jacuzzi, sauna & steam room,
        //             juice bar
        //         </div>
        //     </div>
